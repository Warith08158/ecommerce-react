...
const Deals = () => {
  return (
    <section className="relative mx-auto max-w-[1536px] pt-[5px] mt-[15px] pb-20 bg-deals-bg overflow-x-hidden">
      <div className="container flex flex-col lg:flex-row items-start py-10">
